# `@sebastienrousseau/python-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/python-config`.
...
- [x] **pyproject.toml**: Standardized rule preset
- [x] **ruff.toml**: Standardized rule preset
- [x] **.flake8**: Standardized rule preset
