...
lp=lm?'/python-config/'+lm[1]:'/python-config';
function load(){if(idx)return Promise.resolve();var sp=lm?'/python-config/'+lm[1]+'/search-index.json':'/python-config/search-index.json';return fetch(sp).then(function(r){return r.json()}).then(function(d){idx=d.entries||[]}).catch(function(){idx=[]})}
