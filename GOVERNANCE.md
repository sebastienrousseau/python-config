...
This document describes how @sebastienrousseau/python-config is run: who decides what, how
...
@sebastienrousseau/python-config is **maintainer-led**. As of the current release line it has a single
